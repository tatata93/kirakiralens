...
class MainWindow(QMainWindow):
    ...
    def _build_toolbar(self) -> None:
        ...
        self.max_diameter = spin_box(1.0, 500.0, 1)
    ...
    def _build_workspace(self) -> None:
        ...
        catalog_dock.setMinimumWidth(390)
    ...
    def _targets_changed(self) -> None:
        ...
        self.catalog_panel.max_diameter.setValue(self.max_diameter.value())
    ...
    def _select(self, kind: str, element_index: int, surface_index: int = -1) -> None:
        ...
        self.selected_surface = surface_index if kind == "surface" else -1
        self.inspector.set_selection(self.design, self.selected_element, self.selected_surface)
